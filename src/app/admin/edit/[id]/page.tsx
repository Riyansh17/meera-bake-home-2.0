...
import { getFoodItem, updateFoodItem } from '@/firebase/db';
import { FoodItem, Category } from '@/types/item';
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Update details for "{foodItem.name}"</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            {originalImage && image !== originalImage && (
              <p className="text-sm text-amber-600 mt-2">
                ⚠️ Image has been changed. Save to apply changes.
              </p>
            )}
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-md">
            ...
            <div className="text-xs text-gray-500 space-y-1">
              <p>Created: {foodItem.createdAt.toLocaleDateString()}</p>
              <p>Last Updated: {foodItem.updatedAt.toLocaleDateString()}</p>
              <p>Item ID: {foodItem.id}</p>
            </div>
          </div>
